...
\begin{enumerate}
    ...
    \item Selecciona modo de juego (1 o 2 jugadores)
...
\begin{center}
    \includegraphics[width=\textwidth]{characters/SAW.png}
\end{center}
\end{minipage}
...
\begin{minipage}[t]{0.35\textwidth}
\begin{center}
    \includegraphics[width=\textwidth]{characters/ET.png}
\end{center}
\end{minipage}
...
\begin{minipage}[t]{0.35\textwidth}
\begin{center}
    \includegraphics[width=\textwidth]{characters/ELEVEN.png}
\end{center}
\end{minipage}
...
\begin{minipage}[t]{0.35\textwidth}
\begin{center}
    \includegraphics[width=\textwidth]{characters/HOMER.png}
\end{center}
\end{minipage}
...
\begin{enumerate}
    ...
    \item \textbf{Sistema de juego completo}: El juego incluye selección de personajes, sistema de puntuación, vidas, y progresión de dificultad.
